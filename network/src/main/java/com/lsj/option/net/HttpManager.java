package com.lsj.option.net;

import android.app.Application;

import com.lsj.option.net.provider.BaseUrl;
import com.lsj.option.net.provider.IOKHtttpClientProvider;
import com.lsj.option.net.provider.OkHttpProvider;
import com.lsj.option.net.provider.ServiceProvider;
