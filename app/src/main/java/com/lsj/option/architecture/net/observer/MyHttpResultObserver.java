package com.lsj.option.architecture.net.observer;

import android.text.TextUtils;

import com.lsj.option.architecture.net.dto.Resp;
import com.lsj.option.net.callback.IHttpCallBack;
import com.lsj.option.net.subscriber.IAHttpResultObserver;
