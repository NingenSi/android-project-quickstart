package com.lsj.option.framework.mvp;

import android.support.annotation.Nullable;

import com.lsj.option.framework.base.lifecycleprovider.LifecycleProvider;
import com.lsj.option.framework.base.lifecycleprovider.LifecycleUtils;
...
public class BaseModel implements IModel {
    ...
    /**
     * 有线程切换，绑定页面生命周期。
     * 调用此方法，必须该类必须实现了{@link com.lsj.option.framework.base.IActivity}
     * 或{@link com.lsj.option.framework.base.IFragment}。
